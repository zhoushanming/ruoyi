package com.scheduling.project.system.role.controller;
...
import com.scheduling.common.utils.security.AuthorizationUtils;
...
import com.scheduling.framework.web.domain.Ztree;
import com.scheduling.framework.web.page.TableDataInfo;
import com.scheduling.project.system.dept.service.IDeptService;
import com.scheduling.project.system.role.domain.Role;
import com.scheduling.project.system.role.service.IRoleService;
...
public class RoleController extends BaseController
{
    ...
    @ResponseBody
    public List<Role> lists1(String roleName)
    {
        logger.info("----------"+roleName);
        List<Role> role=roleMapper.selectRoleByName(roleName);
        return role;
    ...
    @GetMapping("/listname")
    @ResponseBody
    public Role lists1(Long categoryId)
    {
        logger.info("----Role------"+categoryId);
        Role role=roleService.selectRoleById(categoryId);
