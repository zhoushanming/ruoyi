...
import com.scheduling.common.utils.file.MimeTypeUtils;
...
public class ProfileController extends BaseController
{
    ...
    public AjaxResult updateAvatar(@RequestParam("avatarfile") MultipartFile file)
    {
        ...
        try
        {
            if (!file.isEmpty())
            {
                String avatar = FileUploadUtils.upload(schedulingConfig.getAvatarPath(), file, MimeTypeUtils.IMAGE_EXTENSION);
