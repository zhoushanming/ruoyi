...
CREATE TABLE `customer`  (
  ...
  `name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '客户姓名',
  `sex` char(1) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `balance` decimal(64, 2) NULL DEFAULT NULL,
...
) ENGINE = MyISAM AUTO_INCREMENT = 3973 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '员工管理' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of customer
-- ----------------------------
INSERT INTO `customer` VALUES (1111, '2111', '男', 5261.23, '13213131313', 'admin', '2023-05-31 19:29:23', '1', '2023-06-07 17:20:33', NULL, '2');
INSERT INTO `customer` VALUES (3971, 'zsm1', '男', 4121.48, '13213131313', '1', '2023-06-07 18:48:30', '1', '2023-06-08 17:20:38', NULL, '0');
INSERT INTO `customer` VALUES (3972, 'test11', '男', 1743.05, '13213131313', '1', '2023-06-08 17:12:51', '1', '2023-06-08 17:20:53', NULL, '0');
...
CREATE TABLE `employee_preferences`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '员工偏好ID',
  `preference_type` int NULL DEFAULT NULL COMMENT '可选值:工作日偏好、工作时间偏好、班次时长偏好。可扩展\n',
  `staff` bigint NULL DEFAULT NULL COMMENT '员工',
  `preference_value` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '偏好值',
  `create_by` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '创建者',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '更新者',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  ...
  `del_flag` char(1) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '0' COMMENT '删除标志（0代表存在 2代表删除）',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 6 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '员工偏好' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `forecastdata`  (
  ...
  `rateflow` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '预测顾客流量',
  `create_by` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '创建者',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '更新者',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `del_flag` char(1) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '0' COMMENT '删除标志（0代表存在 2代表删除）',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '业务预测数据' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `history`  (
  ...
  `custId` bigint NULL DEFAULT NULL,
  `operateDate` datetime NULL DEFAULT NULL,
  `nowBalance` decimal(10, 2) NULL DEFAULT NULL,
  `record` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `phone` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  `custName` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of history
-- ----------------------------
INSERT INTO `history` VALUES (5, 3971, '2023-06-08 11:48:56', 3254.00, '+33', '13213131313', 'zsm');
INSERT INTO `history` VALUES (6, 3971, '2023-06-08 11:49:13', 3157.00, '-97.00', '13213131313', 'zsm');
INSERT INTO `history` VALUES (7, 3971, '2023-06-08 11:49:31', 3142.48, '-14.52', '13213131313', 'zsm');
INSERT INTO `history` VALUES (8, 3971, '2023-06-08 16:49:05', 3076.48, '-66.00', '13213131313', 'zsm');
INSERT INTO `history` VALUES (9, 3972, '2023-06-08 17:12:58', 2111.00, '+1111', '13213131313', 'test11');
INSERT INTO `history` VALUES (10, 3972, '2023-06-08 17:13:04', 1671.44, '-439.56', '13213131313', 'test11');
INSERT INTO `history` VALUES (11, 3971, '2023-06-08 17:20:17', 4187.48, '+1111', '13213131313', 'zsm1');
INSERT INTO `history` VALUES (12, 3971, '2023-06-08 17:20:25', 4187.48, '+0', '13213131313', 'zsm1');
INSERT INTO `history` VALUES (13, 3971, '2023-06-08 17:20:30', 4187.48, '+0', '13213131313', 'zsm1');
INSERT INTO `history` VALUES (14, 3971, '2023-06-08 17:20:38', 4121.48, '+-66', '13213131313', 'zsm1');
INSERT INTO `history` VALUES (15, 3972, '2023-06-08 17:20:49', 1748.44, '+77', '13213131313', 'test11');
INSERT INTO `history` VALUES (16, 3972, '2023-06-08 17:20:53', 1743.05, '-5.39', '13213131313', 'test11');
...
CREATE TABLE `schedule`  (
  `id` int NOT NULL COMMENT 'ID',
  `staff_id` varchar(11) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '员工',
  `rule_id` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '规则ID',
  `create_by` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '创建者',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '更新者',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  ...
  `endtime` datetime NULL DEFAULT NULL COMMENT '结束时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '排班管理' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `staff`  (
  ...
  `position` bigint NULL DEFAULT NULL COMMENT '职位',
  `store_id` bigint NULL DEFAULT NULL COMMENT '员工所属门店id',
  `create_by` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '创建者',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '更新者',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  ...
  `del_flag` char(1) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '0' COMMENT '删除标志（0代表存在 2代表删除）',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 3971 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '员工管理' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `store`  (
  ...
  `name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '门店名称',
  `address` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '门店地址',
  ...
  `del_flag` char(1) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '0' COMMENT '删除标志（0代表存在 2代表删除）',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 4 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '门店管理' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 11 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '参数配置表' ROW_FORMAT = COMPACT;
...
) ENGINE = InnoDB AUTO_INCREMENT = 110 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '部门表' ROW_FORMAT = COMPACT;
...
) ENGINE = InnoDB AUTO_INCREMENT = 42 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '字典数据表' ROW_FORMAT = COMPACT;
...
) ENGINE = InnoDB AUTO_INCREMENT = 14 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '字典类型表' ROW_FORMAT = COMPACT;
...
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '定时任务调度表' ROW_FORMAT = COMPACT;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '定时任务调度日志表' ROW_FORMAT = COMPACT;
...
) ENGINE = InnoDB AUTO_INCREMENT = 143 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '系统访问记录' ROW_FORMAT = COMPACT;
...
INSERT INTO `sys_logininfor` VALUES (77, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '1', '验证码错误', '2023-05-31 15:23:36');
INSERT INTO `sys_logininfor` VALUES (78, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-05-31 15:23:42');
INSERT INTO `sys_logininfor` VALUES (79, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-05-31 16:50:50');
INSERT INTO `sys_logininfor` VALUES (80, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-05-31 17:05:34');
INSERT INTO `sys_logininfor` VALUES (81, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-05-31 18:47:45');
INSERT INTO `sys_logininfor` VALUES (82, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-05-31 18:51:39');
INSERT INTO `sys_logininfor` VALUES (83, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-05-31 19:28:31');
INSERT INTO `sys_logininfor` VALUES (84, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-02 18:36:44');
INSERT INTO `sys_logininfor` VALUES (85, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-02 18:42:47');
INSERT INTO `sys_logininfor` VALUES (86, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-06 16:35:52');
INSERT INTO `sys_logininfor` VALUES (87, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-06 16:51:41');
INSERT INTO `sys_logininfor` VALUES (88, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-06 19:41:46');
INSERT INTO `sys_logininfor` VALUES (89, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-06 19:48:06');
INSERT INTO `sys_logininfor` VALUES (90, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-07 10:37:16');
INSERT INTO `sys_logininfor` VALUES (91, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-07 10:47:27');
INSERT INTO `sys_logininfor` VALUES (92, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-07 11:10:35');
INSERT INTO `sys_logininfor` VALUES (93, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '退出成功', '2023-06-07 11:15:52');
INSERT INTO `sys_logininfor` VALUES (94, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-07 11:15:56');
INSERT INTO `sys_logininfor` VALUES (95, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-07 11:17:30');
INSERT INTO `sys_logininfor` VALUES (96, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-07 11:22:12');
INSERT INTO `sys_logininfor` VALUES (97, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-07 11:24:28');
INSERT INTO `sys_logininfor` VALUES (98, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-07 11:25:41');
INSERT INTO `sys_logininfor` VALUES (99, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-07 14:48:03');
INSERT INTO `sys_logininfor` VALUES (100, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-07 14:54:02');
INSERT INTO `sys_logininfor` VALUES (101, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-07 14:54:46');
INSERT INTO `sys_logininfor` VALUES (102, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-07 15:12:30');
INSERT INTO `sys_logininfor` VALUES (103, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-07 15:15:39');
INSERT INTO `sys_logininfor` VALUES (104, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-07 15:16:55');
INSERT INTO `sys_logininfor` VALUES (105, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-07 15:19:17');
INSERT INTO `sys_logininfor` VALUES (106, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-07 15:21:02');
INSERT INTO `sys_logininfor` VALUES (107, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-07 15:34:32');
INSERT INTO `sys_logininfor` VALUES (108, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-07 15:38:17');
INSERT INTO `sys_logininfor` VALUES (109, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-07 15:58:05');
INSERT INTO `sys_logininfor` VALUES (110, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-07 16:04:28');
INSERT INTO `sys_logininfor` VALUES (111, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-07 16:12:02');
INSERT INTO `sys_logininfor` VALUES (112, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-07 16:17:56');
INSERT INTO `sys_logininfor` VALUES (113, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-07 16:29:58');
INSERT INTO `sys_logininfor` VALUES (114, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-07 16:41:11');
INSERT INTO `sys_logininfor` VALUES (115, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-07 17:01:26');
INSERT INTO `sys_logininfor` VALUES (116, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-07 17:03:07');
INSERT INTO `sys_logininfor` VALUES (117, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-07 18:21:41');
INSERT INTO `sys_logininfor` VALUES (118, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-07 18:28:21');
INSERT INTO `sys_logininfor` VALUES (119, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-07 18:29:10');
INSERT INTO `sys_logininfor` VALUES (120, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-07 18:31:55');
INSERT INTO `sys_logininfor` VALUES (121, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-07 18:35:19');
INSERT INTO `sys_logininfor` VALUES (122, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-07 18:38:36');
INSERT INTO `sys_logininfor` VALUES (123, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-07 18:40:26');
INSERT INTO `sys_logininfor` VALUES (124, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-07 18:41:54');
INSERT INTO `sys_logininfor` VALUES (125, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-07 18:42:49');
INSERT INTO `sys_logininfor` VALUES (126, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-07 18:44:49');
INSERT INTO `sys_logininfor` VALUES (127, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-07 18:46:04');
INSERT INTO `sys_logininfor` VALUES (128, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-07 18:48:13');
INSERT INTO `sys_logininfor` VALUES (129, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-07 18:50:38');
INSERT INTO `sys_logininfor` VALUES (130, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-08 11:23:28');
INSERT INTO `sys_logininfor` VALUES (131, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-08 11:26:54');
INSERT INTO `sys_logininfor` VALUES (132, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-08 11:34:38');
INSERT INTO `sys_logininfor` VALUES (133, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-08 11:38:52');
INSERT INTO `sys_logininfor` VALUES (134, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-08 11:44:36');
INSERT INTO `sys_logininfor` VALUES (135, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-08 11:47:17');
INSERT INTO `sys_logininfor` VALUES (136, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-08 11:48:46');
INSERT INTO `sys_logininfor` VALUES (137, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-08 16:48:55');
INSERT INTO `sys_logininfor` VALUES (138, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-08 17:00:11');
INSERT INTO `sys_logininfor` VALUES (139, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-08 17:03:35');
INSERT INTO `sys_logininfor` VALUES (140, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-08 17:14:11');
INSERT INTO `sys_logininfor` VALUES (141, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-08 17:31:37');
INSERT INTO `sys_logininfor` VALUES (142, 'admin', '127.0.0.1', '内网IP', 'Chrome 11', 'Windows 10', '0', '登录成功', '2023-06-08 17:35:22');
...
) ENGINE = InnoDB AUTO_INCREMENT = 1112 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '菜单权限表' ROW_FORMAT = COMPACT;
...
INSERT INTO `sys_menu` VALUES (1062, '门店管理', 0, 1, '/system/store', 'menuItem', 'M', '1', '1', 'system:store:view', 'fa fa-institution', 'admin', '2023-02-14 02:01:47', 'admin', '2023-06-08 17:15:55', '门店管理菜单');
...
INSERT INTO `sys_menu` VALUES (1074, '排班规则管理', 0, 1, '/system/rules', 'menuItem', 'M', '1', '1', 'system:rules:view', 'fa fa-window-restore', 'admin', '2023-02-14 09:47:57', 'admin', '2023-06-08 17:15:21', '排版规则管理菜单');
...
INSERT INTO `sys_menu` VALUES (1080, '业务预测数据', 0, 1, '/system/forecastdata', 'menuItem', 'M', '1', '1', 'system:forecastdata:view', 'fa fa-building-o', 'admin', '2023-02-23 03:20:46', 'admin', '2023-06-08 17:15:29', '业务预测数据菜单');
...
INSERT INTO `sys_menu` VALUES (1086, '充值消费记录', 0, 1, '/system/schedule', 'menuItem', 'M', '0', '1', 'system:schedule:view', 'fa fa-address-card-o', 'admin', '2023-02-23 10:29:13', 'admin', '2023-06-08 16:52:51', '排班管理菜单');
...
INSERT INTO `sys_menu` VALUES (1098, '员工偏好', 0, 1, '/system/preferences', 'menuItem', 'M', '1', '1', 'system:preferences:view', 'fa fa-bookmark-o', 'admin', '2023-02-23 11:09:49', 'admin', '2023-06-08 17:15:39', '员工偏好菜单');
...
INSERT INTO `sys_menu` VALUES (1106, '客户管理', 0, 1, '/system/cust', 'menuItem', 'M', '0', '1', 'system:cust:view', 'fa fa-users', 'admin', '2023-02-14 09:42:12', 'admin', '2023-02-18 11:46:18', '客户管理菜单');
INSERT INTO `sys_menu` VALUES (1107, '客户管理查询', 1106, 1, '#', '', 'F', '0', '1', 'system:cust:list', '#', 'admin', '2023-02-14 09:42:12', '', NULL, '');
INSERT INTO `sys_menu` VALUES (1108, '客户管理新增', 1106, 2, '#', '', 'F', '0', '1', 'system:cust:add', '#', 'admin', '2023-02-14 09:42:12', '', NULL, '');
INSERT INTO `sys_menu` VALUES (1109, '客户管理修改', 1106, 3, '#', '', 'F', '0', '1', 'system:cust:edit', '#', 'admin', '2023-02-14 09:42:12', '', NULL, '');
INSERT INTO `sys_menu` VALUES (1110, '客户管理删除', 1106, 4, '#', '', 'F', '0', '1', 'system:cust:remove', '#', 'admin', '2023-02-14 09:42:12', '', NULL, '');
INSERT INTO `sys_menu` VALUES (1111, '客户管理导出', 1106, 5, '#', '', 'F', '0', '1', 'system:cust:export', '#', 'admin', '2023-02-14 09:42:12', '', NULL, '');
...
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '通知公告表' ROW_FORMAT = COMPACT;
...
) ENGINE = InnoDB AUTO_INCREMENT = 188 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '操作日志记录' ROW_FORMAT = COMPACT;
...
INSERT INTO `sys_oper_log` VALUES (136, '菜单管理', 1, 'com.scheduling.project.system.menu.controller.MenuController.addSave()', 'POST', 1, 'admin', '研发部门', '/system/menu/add', '127.0.0.1', '内网IP', '{\"parentId\":[\"0\"],\"menuType\":[\"M\"],\"menuName\":[\"客户管理\"],\"url\":[\"\"],\"target\":[\"menuItem\"],\"perms\":[\"\"],\"orderNum\":[\"1\"],\"icon\":[\"fa fa-address-book\"],\"visible\":[\"0\"],\"isRefresh\":[\"1\"]}', '{\"msg\":\"操作成功\",\"code\":0}', 0, NULL, '2023-05-31 16:58:09');
INSERT INTO `sys_oper_log` VALUES (137, '菜单管理', 3, 'com.scheduling.project.system.menu.controller.MenuController.remove()', 'GET', 1, 'admin', '研发部门', '/system/menu/remove/1104', '127.0.0.1', '内网IP', '1104', '{\"msg\":\"操作成功\",\"code\":0}', 0, NULL, '2023-06-07 11:15:43');
INSERT INTO `sys_oper_log` VALUES (138, '员工管理', 2, 'com.scheduling.project.system.cust.controller.CustController.editSave()', 'POST', 1, 'admin', '研发部门', '/system/cust/edit', '127.0.0.1', '内网IP', '{\"id\":[\"1111\"],\"name\":[\"zsm\"],\"sex\":[\"男\"],\"phone\":[\"13213131313\"],\"balance\":[\"1000\"],\"recharge\":[\"1111\"]}', NULL, 1, 'nested exception is org.apache.ibatis.reflection.ReflectionException: There is no getter for property named \'email\' in \'class com.scheduling.project.system.cust.domain.Cust\'', '2023-06-07 15:12:40');
INSERT INTO `sys_oper_log` VALUES (139, '员工管理', 2, 'com.scheduling.project.system.cust.controller.CustController.editSave()', 'POST', 1, 'admin', '研发部门', '/system/cust/edit', '127.0.0.1', '内网IP', '{\"id\":[\"1111\"],\"name\":[\"zsm\"],\"sex\":[\"男\"],\"phone\":[\"13213131313\"],\"balance\":[\"1000\"],\"recharge\":[\"1111\"]}', NULL, 1, 'nested exception is org.apache.ibatis.reflection.ReflectionException: There is no getter for property named \'email\' in \'class com.scheduling.project.system.cust.domain.Cust\'', '2023-06-07 15:13:04');
INSERT INTO `sys_oper_log` VALUES (140, '员工管理', 2, 'com.scheduling.project.system.cust.controller.CustController.editSave()', 'POST', 1, 'admin', '研发部门', '/system/cust/edit', '127.0.0.1', '内网IP', '{\"id\":[\"1111\"],\"name\":[\"zsm\"],\"sex\":[\"男\"],\"phone\":[\"13213131313\"],\"balance\":[\"1000\"],\"recharge\":[\"2222\"]}', '{\"msg\":\"操作成功\",\"code\":0}', 0, NULL, '2023-06-07 15:15:48');
INSERT INTO `sys_oper_log` VALUES (141, '员工管理', 2, 'com.scheduling.project.system.cust.controller.CustController.recharge()', 'POST', 1, 'admin', '研发部门', '/system/cust/recharge', '127.0.0.1', '内网IP', '{\"id\":[\"1111\"],\"name\":[\"zsm\"],\"sex\":[\"男\"],\"phone\":[\"13213131313\"],\"balance\":[\"1000\"],\"recharge\":[\"666\"]}', '{\"msg\":\"操作成功\",\"code\":0}', 0, NULL, '2023-06-07 15:17:06');
INSERT INTO `sys_oper_log` VALUES (142, '员工管理', 2, 'com.scheduling.project.system.cust.controller.CustController.recharge()', 'POST', 1, 'admin', '研发部门', '/system/cust/recharge', '127.0.0.1', '内网IP', '{\"id\":[\"1111\"],\"name\":[\"zsm\"],\"sex\":[\"男\"],\"phone\":[\"13213131313\"],\"balance\":[\"1000\"],\"recharge\":[\"555\"]}', '{\"msg\":\"操作成功\",\"code\":0}', 0, NULL, '2023-06-07 15:18:58');
INSERT INTO `sys_oper_log` VALUES (143, '员工管理', 2, 'com.scheduling.project.system.cust.controller.CustController.recharge()', 'POST', 1, 'admin', '研发部门', '/system/cust/recharge', '127.0.0.1', '内网IP', '{\"id\":[\"1111\"],\"name\":[\"zsm\"],\"sex\":[\"男\"],\"phone\":[\"13213131313\"],\"balance\":[\"1000\"],\"recharge\":[\"1111\"]}', '{\"msg\":\"操作成功\",\"code\":0}', 0, NULL, '2023-06-07 15:19:29');
INSERT INTO `sys_oper_log` VALUES (144, '员工管理', 2, 'com.scheduling.project.system.cust.controller.CustController.recharge()', 'POST', 1, 'admin', '研发部门', '/system/cust/recharge', '127.0.0.1', '内网IP', '{\"id\":[\"1111\"],\"name\":[\"2111\"],\"sex\":[\"男\"],\"phone\":[\"13213131313\"],\"balance\":[\"1000\"],\"recharge\":[\"3333\"]}', '{\"msg\":\"操作成功\",\"code\":0}', 0, NULL, '2023-06-07 15:21:15');
INSERT INTO `sys_oper_log` VALUES (145, '员工管理', 2, 'com.scheduling.project.system.cust.controller.CustController.recharge()', 'POST', 1, 'admin', '研发部门', '/system/cust/recharge', '127.0.0.1', '内网IP', '{\"id\":[\"1111\"],\"name\":[\"2111\"],\"sex\":[\"男\"],\"phone\":[\"13213131313\"],\"balance\":[\"4333\"]}', NULL, 1, '', '2023-06-07 16:30:14');
INSERT INTO `sys_oper_log` VALUES (146, '员工管理', 2, 'com.scheduling.project.system.cust.controller.CustController.recharge()', 'POST', 1, 'admin', '研发部门', '/system/cust/recharge', '127.0.0.1', '内网IP', '{\"id\":[\"1111\"],\"name\":[\"2111\"],\"sex\":[\"男\"],\"phone\":[\"13213131313\"],\"balance\":[\"4333\"]}', NULL, 1, '', '2023-06-07 16:34:23');
INSERT INTO `sys_oper_log` VALUES (147, '员工管理', 2, 'com.scheduling.project.system.cust.controller.CustController.recharge()', 'POST', 1, 'admin', '研发部门', '/system/cust/recharge', '127.0.0.1', '内网IP', '{\"id\":[\"1111\"],\"name\":[\"2111\"],\"sex\":[\"男\"],\"phone\":[\"13213131313\"],\"balance\":[\"4333\"],\"recharge\":[\"555\"]}', '{\"msg\":\"操作成功\",\"code\":0}', 0, NULL, '2023-06-07 16:44:57');
INSERT INTO `sys_oper_log` VALUES (148, '员工管理', 2, 'com.scheduling.project.system.cust.controller.CustController.recharge()', 'POST', 1, 'admin', '研发部门', '/system/cust/recharge', '127.0.0.1', '内网IP', '{\"id\":[\"1111\"],\"name\":[\"2111\"],\"sex\":[\"男\"],\"phone\":[\"13213131313\"],\"balance\":[\"4888\"],\"recharge\":[\"1111\"]}', '{\"msg\":\"操作成功\",\"code\":0}', 0, NULL, '2023-06-07 16:45:06');
INSERT INTO `sys_oper_log` VALUES (149, '员工管理', 2, 'com.scheduling.project.system.cust.controller.CustController.recharge()', 'POST', 1, 'admin', '研发部门', '/system/cust/recharge', '127.0.0.1', '内网IP', '{\"id\":[\"1111\"],\"name\":[\"2111\"],\"sex\":[\"男\"],\"phone\":[\"13213131313\"],\"balance\":[\"5999\"],\"consume\":[\"100\"],\"discount\":[\"97\"]}', NULL, 1, '', '2023-06-07 17:05:26');
INSERT INTO `sys_oper_log` VALUES (150, '员工管理', 2, 'com.scheduling.project.system.cust.controller.CustController.consume()', 'POST', 1, 'admin', '研发部门', '/system/cust/consume', '127.0.0.1', '内网IP', '{\"id\":[\"1111\"],\"name\":[\"2111\"],\"sex\":[\"男\"],\"phone\":[\"13213131313\"],\"balance\":[\"5999\"],\"consume\":[\"100\"],\"discount\":[\"97\"]}', '{\"msg\":\"操作成功\",\"code\":0}', 0, NULL, '2023-06-07 17:06:34');
INSERT INTO `sys_oper_log` VALUES (151, '员工管理', 2, 'com.scheduling.project.system.cust.controller.CustController.consume()', 'POST', 1, 'admin', '研发部门', '/system/cust/consume', '127.0.0.1', '内网IP', '{\"id\":[\"1111\"],\"name\":[\"2111\"],\"sex\":[\"男\"],\"phone\":[\"13213131313\"],\"balance\":[\"5902\"],\"consume\":[\"44\"],\"discount\":[\"55\"]}', '{\"msg\":\"操作成功\",\"code\":0}', 0, NULL, '2023-06-07 17:07:09');
INSERT INTO `sys_oper_log` VALUES (152, '员工管理', 2, 'com.scheduling.project.system.cust.controller.CustController.consume()', 'POST', 1, 'admin', '研发部门', '/system/cust/consume', '127.0.0.1', '内网IP', '{\"id\":[\"1111\"],\"name\":[\"2111\"],\"sex\":[\"男\"],\"phone\":[\"13213131313\"],\"balance\":[\"5878\"],\"consume\":[\"666\"],\"discount\":[\"66\"]}', '{\"msg\":\"操作成功\",\"code\":0}', 0, NULL, '2023-06-07 17:09:15');
INSERT INTO `sys_oper_log` VALUES (153, '员工管理', 2, 'com.scheduling.project.system.cust.controller.CustController.consume()', 'POST', 1, 'admin', '研发部门', '/system/cust/consume', '127.0.0.1', '内网IP', '{\"id\":[\"1111\"],\"name\":[\"2111\"],\"sex\":[\"男\"],\"phone\":[\"13213131313\"],\"balance\":[\"5438.00\"],\"consume\":[\"55\"],\"discount\":[\"55\"]}', '{\"msg\":\"操作成功\",\"code\":0}', 0, NULL, '2023-06-07 17:20:20');
INSERT INTO `sys_oper_log` VALUES (154, '员工管理', 2, 'com.scheduling.project.system.cust.controller.CustController.consume()', 'POST', 1, 'admin', '研发部门', '/system/cust/consume', '127.0.0.1', '内网IP', '{\"id\":[\"1111\"],\"name\":[\"2111\"],\"sex\":[\"男\"],\"phone\":[\"13213131313\"],\"balance\":[\"5407.75\"],\"consume\":[\"666\"],\"discount\":[\"22\"]}', '{\"msg\":\"操作成功\",\"code\":0}', 0, NULL, '2023-06-07 17:20:33');
INSERT INTO `sys_oper_log` VALUES (155, '员工管理', 1, 'com.scheduling.project.system.cust.controller.CustController.addSave()', 'POST', 1, 'admin', '研发部门', '/system/cust/add', '127.0.0.1', '内网IP', '{\"name\":[\"zsm\"],\"sex\":[\"男\"],\"phone\":[\"121212\"],\"balance\":[\"1000\"]}', NULL, 1, 'nested exception is org.apache.ibatis.reflection.ReflectionException: There is no getter for property named \'email\' in \'class com.scheduling.project.system.cust.domain.Cust\'', '2023-06-07 18:46:29');
INSERT INTO `sys_oper_log` VALUES (156, '员工管理', 1, 'com.scheduling.project.system.cust.controller.CustController.addSave()', 'POST', 1, 'admin', '研发部门', '/system/cust/add', '127.0.0.1', '内网IP', '{\"name\":[\"zsm\"],\"sex\":[\"男\"],\"phone\":[\"13213131313\"],\"balance\":[\"111\"]}', '{\"msg\":\"操作成功\",\"code\":0}', 0, NULL, '2023-06-07 18:48:30');
INSERT INTO `sys_oper_log` VALUES (157, '员工管理', 3, 'com.scheduling.project.system.cust.controller.CustController.remove()', 'POST', 1, 'admin', '研发部门', '/system/cust/remove', '127.0.0.1', '内网IP', '{\"ids\":[\"1111\"]}', NULL, 1, 'Invalid bound statement (not found): com.scheduling.project.system.cust.mapper.CustMapper.deleteEmployeePreferencesByCusts', '2023-06-07 18:49:52');
INSERT INTO `sys_oper_log` VALUES (158, '员工管理', 3, 'com.scheduling.project.system.cust.controller.CustController.remove()', 'POST', 1, 'admin', '研发部门', '/system/cust/remove', '127.0.0.1', '内网IP', '{\"ids\":[\"1111\"]}', '{\"msg\":\"操作成功\",\"code\":0}', 0, NULL, '2023-06-07 18:50:46');
INSERT INTO `sys_oper_log` VALUES (159, '员工管理', 5, 'com.scheduling.project.system.cust.controller.CustController.export()', 'POST', 1, 'admin', '研发部门', '/system/cust/export', '127.0.0.1', '内网IP', '{\"name\":[\"\"],\"phone\":[\"\"],\"orderByColumn\":[\"\"],\"isAsc\":[\"asc\"]}', NULL, 1, '导出Excel失败，请联系网站管理员！', '2023-06-07 18:50:49');
INSERT INTO `sys_oper_log` VALUES (160, '员工管理', 2, 'com.scheduling.project.system.cust.controller.CustController.recharge()', 'POST', 1, 'admin', '研发部门', '/system/cust/recharge', '127.0.0.1', '内网IP', '{\"id\":[\"3971\"],\"name\":[\"zsm\"],\"sex\":[\"男\"],\"phone\":[\"13213131313\"],\"balance\":[\"111.00\"],\"recharge\":[\"1111\"]}', NULL, 1, '\r\n### Error updating database.  Cause: java.sql.SQLException: Field \'id\' doesn\'t have a default value\r\n### The error may exist in file [C:\\Users\\smzhou1\\Desktop\\scheduling\\target\\classes\\mybatis\\system\\HistoryMapper.xml]\r\n### The error may involve com.scheduling.project.system.cust.mapper.HistoryMapper.insertHistory-Inline\r\n### The error occurred while setting parameters\r\n### SQL: insert into history          ( custName,                                           operateDate,                                           record,                                           phone,                                           nowBalance )           values ( ?,                                           ?,                                           ?,                                           ?,                                           ? )\r\n### Cause: java.sql.SQLException: Field \'id\' doesn\'t have a default value\n; Field \'id\' doesn\'t have a default value; nested exception is java.sql.SQLException: Field \'id\' doesn\'t have a default value', '2023-06-08 11:23:37');
INSERT INTO `sys_oper_log` VALUES (161, '员工管理', 2, 'com.scheduling.project.system.cust.controller.CustController.recharge()', 'POST', 1, 'admin', '研发部门', '/system/cust/recharge', '127.0.0.1', '内网IP', '{\"id\":[\"3971\"],\"name\":[\"zsm\"],\"sex\":[\"男\"],\"phone\":[\"13213131313\"],\"balance\":[\"111.00\"],\"recharge\":[\"1111\"]}', '{\"msg\":\"操作成功\",\"code\":0}', 0, NULL, '2023-06-08 11:27:01');
INSERT INTO `sys_oper_log` VALUES (162, '员工管理', 2, 'com.scheduling.project.system.cust.controller.CustController.recharge()', 'POST', 1, 'admin', '研发部门', '/system/cust/recharge', '127.0.0.1', '内网IP', '{\"id\":[\"3971\"],\"name\":[\"zsm\"],\"sex\":[\"男\"],\"phone\":[\"13213131313\"],\"balance\":[\"1222.00\"],\"recharge\":[\"1111\"]}', '{\"msg\":\"操作成功\",\"code\":0}', 0, NULL, '2023-06-08 11:27:08');
INSERT INTO `sys_oper_log` VALUES (163, '员工管理', 2, 'com.scheduling.project.system.cust.controller.CustController.recharge()', 'POST', 1, 'admin', '研发部门', '/system/cust/recharge', '127.0.0.1', '内网IP', '{\"id\":[\"3971\",\"3971\"],\"name\":[\"zsm\"],\"sex\":[\"男\"],\"phone\":[\"13213131313\"],\"balance\":[\"2333.00\"],\"recharge\":[\"333\"]}', '{\"msg\":\"操作成功\",\"code\":0}', 0, NULL, '2023-06-08 11:34:48');
INSERT INTO `sys_oper_log` VALUES (164, '员工管理', 2, 'com.scheduling.project.system.cust.controller.CustController.recharge()', 'POST', 1, 'admin', '研发部门', '/system/cust/recharge', '127.0.0.1', '内网IP', '{\"id\":[\"3971\",\"3971\"],\"name\":[\"zsm\"],\"sex\":[\"男\"],\"phone\":[\"13213131313\"],\"balance\":[\"2666.00\"],\"recharge\":[\"555\"]}', '{\"msg\":\"操作成功\",\"code\":0}', 0, NULL, '2023-06-08 11:36:54');
INSERT INTO `sys_oper_log` VALUES (165, '员工管理', 2, 'com.scheduling.project.system.cust.controller.CustController.recharge()', 'POST', 1, 'admin', '研发部门', '/system/cust/recharge', '127.0.0.1', '内网IP', '{\"id\":[\"3971\",\"3971\"],\"name\":[\"zsm\"],\"sex\":[\"男\"],\"phone\":[\"13213131313\"],\"balance\":[\"3221.00\"],\"recharge\":[\"1111\"]}', NULL, 1, 'nested exception is org.apache.ibatis.reflection.ReflectionException: There is no getter for property named \'custId\' in \'class com.scheduling.project.system.cust.domain.History\'', '2023-06-08 11:39:05');
INSERT INTO `sys_oper_log` VALUES (166, '员工管理', 2, 'com.scheduling.project.system.cust.controller.CustController.recharge()', 'POST', 1, 'admin', '研发部门', '/system/cust/recharge', '127.0.0.1', '内网IP', '{\"id\":[\"3971\",\"3971\"],\"name\":[\"zsm\"],\"sex\":[\"男\"],\"phone\":[\"13213131313\"],\"balance\":[\"3221.00\"],\"recharge\":[\"111\"]}', NULL, 1, 'nested exception is org.apache.ibatis.reflection.ReflectionException: There is no getter for property named \'custId\' in \'class com.scheduling.project.system.cust.domain.History\'', '2023-06-08 11:40:51');
INSERT INTO `sys_oper_log` VALUES (167, '员工管理', 2, 'com.scheduling.project.system.cust.controller.CustController.recharge()', 'POST', 1, 'admin', '研发部门', '/system/cust/recharge', '127.0.0.1', '内网IP', '{\"id\":[\"3971\",\"3971\"],\"name\":[\"zsm\"],\"sex\":[\"男\"],\"phone\":[\"13213131313\"],\"balance\":[\"3221.00\"],\"recharge\":[\"1111\"]}', NULL, 1, 'nested exception is org.apache.ibatis.reflection.ReflectionException: There is no getter for property named \'custId\' in \'class com.scheduling.project.system.cust.domain.History\'', '2023-06-08 11:44:55');
INSERT INTO `sys_oper_log` VALUES (168, '员工管理', 2, 'com.scheduling.project.system.cust.controller.CustController.recharge()', 'POST', 1, 'admin', '研发部门', '/system/cust/recharge', '127.0.0.1', '内网IP', '{\"id\":[\"3971\",\"3971\"],\"name\":[\"zsm\"],\"sex\":[\"男\"],\"phone\":[\"13213131313\"],\"balance\":[\"3221.00\"],\"recharge\":[\"1111\"]}', NULL, 1, 'nested exception is org.apache.ibatis.reflection.ReflectionException: There is no getter for property named \'custId\' in \'class com.scheduling.project.system.cust.domain.History\'', '2023-06-08 11:48:21');
INSERT INTO `sys_oper_log` VALUES (169, '员工管理', 2, 'com.scheduling.project.system.cust.controller.CustController.recharge()', 'POST', 1, 'admin', '研发部门', '/system/cust/recharge', '127.0.0.1', '内网IP', '{\"id\":[\"3971\",\"3971\"],\"name\":[\"zsm\"],\"sex\":[\"男\"],\"phone\":[\"13213131313\"],\"balance\":[\"3221.00\"],\"recharge\":[\"33\"]}', '{\"msg\":\"操作成功\",\"code\":0}', 0, NULL, '2023-06-08 11:48:56');
INSERT INTO `sys_oper_log` VALUES (170, '员工管理', 2, 'com.scheduling.project.system.cust.controller.CustController.consume()', 'POST', 1, 'admin', '研发部门', '/system/cust/consume', '127.0.0.1', '内网IP', '{\"id\":[\"3971\",\"3971\"],\"name\":[\"zsm\"],\"sex\":[\"男\"],\"phone\":[\"13213131313\"],\"balance\":[\"3254.00\"],\"consume\":[\"100\"],\"discount\":[\"97\"]}', '{\"msg\":\"操作成功\",\"code\":0}', 0, NULL, '2023-06-08 11:49:13');
INSERT INTO `sys_oper_log` VALUES (171, '员工管理', 2, 'com.scheduling.project.system.cust.controller.CustController.consume()', 'POST', 1, 'admin', '研发部门', '/system/cust/consume', '127.0.0.1', '内网IP', '{\"id\":[\"3971\",\"3971\"],\"name\":[\"zsm\"],\"sex\":[\"男\"],\"phone\":[\"13213131313\"],\"balance\":[\"3157.00\"],\"consume\":[\"33\"],\"discount\":[\"44\"]}', '{\"msg\":\"操作成功\",\"code\":0}', 0, NULL, '2023-06-08 11:49:31');
INSERT INTO `sys_oper_log` VALUES (172, '员工管理', 2, 'com.scheduling.project.system.cust.controller.CustController.consume()', 'POST', 1, 'admin', '研发部门', '/system/cust/consume', '127.0.0.1', '内网IP', '{\"id\":[\"3971\",\"3971\"],\"name\":[\"zsm\"],\"sex\":[\"男\"],\"phone\":[\"13213131313\"],\"balance\":[\"3142.48\"],\"consume\":[\"100\"],\"discount\":[\"66\"]}', '{\"msg\":\"操作成功\",\"code\":0}', 0, NULL, '2023-06-08 16:49:05');
INSERT INTO `sys_oper_log` VALUES (173, '员工管理', 2, 'com.scheduling.project.system.cust.controller.CustController.editSave()', 'POST', 1, 'admin', '研发部门', '/system/cust/edit', '127.0.0.1', '内网IP', '{\"id\":[\"3971\"],\"name\":[\"zsm1\"],\"sex\":[\"男\"],\"phone\":[\"13213131313\"],\"balance\":[\"3076.48\"]}', '{\"msg\":\"操作成功\",\"code\":0}', 0, NULL, '2023-06-08 16:49:40');
INSERT INTO `sys_oper_log` VALUES (174, '菜单管理', 2, 'com.scheduling.project.system.menu.controller.MenuController.editSave()', 'POST', 1, 'admin', '研发部门', '/system/menu/edit', '127.0.0.1', '内网IP', '{\"menuId\":[\"1086\"],\"parentId\":[\"0\"],\"menuType\":[\"M\"],\"menuName\":[\"充值消费记录\"],\"url\":[\"/system/schedule\"],\"target\":[\"menuItem\"],\"perms\":[\"system:schedule:view\"],\"orderNum\":[\"1\"],\"icon\":[\"fa fa-address-card-o\"],\"visible\":[\"0\"],\"isRefresh\":[\"1\"]}', '{\"msg\":\"操作成功\",\"code\":0}', 0, NULL, '2023-06-08 16:52:51');
INSERT INTO `sys_oper_log` VALUES (175, '员工管理', 1, 'com.scheduling.project.system.cust.controller.CustController.addSave()', 'POST', 1, 'admin', '研发部门', '/system/cust/add', '127.0.0.1', '内网IP', '{\"name\":[\"test11\"],\"sex\":[\"男\"],\"phone\":[\"13213131313\"],\"balance\":[\"1000\"]}', '{\"msg\":\"操作成功\",\"code\":0}', 0, NULL, '2023-06-08 17:12:51');
INSERT INTO `sys_oper_log` VALUES (176, '员工管理', 2, 'com.scheduling.project.system.cust.controller.CustController.recharge()', 'POST', 1, 'admin', '研发部门', '/system/cust/recharge', '127.0.0.1', '内网IP', '{\"id\":[\"3972\",\"3972\"],\"name\":[\"test11\"],\"sex\":[\"男\"],\"phone\":[\"13213131313\"],\"balance\":[\"1000.00\"],\"recharge\":[\"1111\"]}', '{\"msg\":\"操作成功\",\"code\":0}', 0, NULL, '2023-06-08 17:12:58');
INSERT INTO `sys_oper_log` VALUES (177, '员工管理', 2, 'com.scheduling.project.system.cust.controller.CustController.consume()', 'POST', 1, 'admin', '研发部门', '/system/cust/consume', '127.0.0.1', '内网IP', '{\"id\":[\"3972\",\"3972\"],\"name\":[\"test11\"],\"sex\":[\"男\"],\"phone\":[\"13213131313\"],\"balance\":[\"2111.00\"],\"consume\":[\"666\"],\"discount\":[\"66\"]}', '{\"msg\":\"操作成功\",\"code\":0}', 0, NULL, '2023-06-08 17:13:04');
INSERT INTO `sys_oper_log` VALUES (178, '菜单管理', 2, 'com.scheduling.project.system.menu.controller.MenuController.editSave()', 'POST', 1, 'admin', '研发部门', '/system/menu/edit', '127.0.0.1', '内网IP', '{\"menuId\":[\"1074\"],\"parentId\":[\"0\"],\"menuType\":[\"M\"],\"menuName\":[\"排班规则管理\"],\"url\":[\"/system/rules\"],\"target\":[\"menuItem\"],\"perms\":[\"system:rules:view\"],\"orderNum\":[\"1\"],\"icon\":[\"fa fa-window-restore\"],\"visible\":[\"1\"],\"isRefresh\":[\"1\"]}', '{\"msg\":\"操作成功\",\"code\":0}', 0, NULL, '2023-06-08 17:15:21');
INSERT INTO `sys_oper_log` VALUES (179, '菜单管理', 2, 'com.scheduling.project.system.menu.controller.MenuController.editSave()', 'POST', 1, 'admin', '研发部门', '/system/menu/edit', '127.0.0.1', '内网IP', '{\"menuId\":[\"1080\"],\"parentId\":[\"0\"],\"menuType\":[\"M\"],\"menuName\":[\"业务预测数据\"],\"url\":[\"/system/forecastdata\"],\"target\":[\"menuItem\"],\"perms\":[\"system:forecastdata:view\"],\"orderNum\":[\"1\"],\"icon\":[\"fa fa-building-o\"],\"visible\":[\"1\"],\"isRefresh\":[\"1\"]}', '{\"msg\":\"操作成功\",\"code\":0}', 0, NULL, '2023-06-08 17:15:29');
INSERT INTO `sys_oper_log` VALUES (180, '菜单管理', 2, 'com.scheduling.project.system.menu.controller.MenuController.editSave()', 'POST', 1, 'admin', '研发部门', '/system/menu/edit', '127.0.0.1', '内网IP', '{\"menuId\":[\"1098\"],\"parentId\":[\"0\"],\"menuType\":[\"M\"],\"menuName\":[\"员工偏好\"],\"url\":[\"/system/preferences\"],\"target\":[\"menuItem\"],\"perms\":[\"system:preferences:view\"],\"orderNum\":[\"1\"],\"icon\":[\"fa fa-bookmark-o\"],\"visible\":[\"1\"],\"isRefresh\":[\"1\"]}', '{\"msg\":\"操作成功\",\"code\":0}', 0, NULL, '2023-06-08 17:15:39');
INSERT INTO `sys_oper_log` VALUES (181, '菜单管理', 2, 'com.scheduling.project.system.menu.controller.MenuController.editSave()', 'POST', 1, 'admin', '研发部门', '/system/menu/edit', '127.0.0.1', '内网IP', '{\"menuId\":[\"1062\"],\"parentId\":[\"0\"],\"menuType\":[\"M\"],\"menuName\":[\"门店管理\"],\"url\":[\"/system/store\"],\"target\":[\"menuItem\"],\"perms\":[\"system:store:view\"],\"orderNum\":[\"1\"],\"icon\":[\"fa fa-institution\"],\"visible\":[\"1\"],\"isRefresh\":[\"1\"]}', '{\"msg\":\"操作成功\",\"code\":0}', 0, NULL, '2023-06-08 17:15:55');
INSERT INTO `sys_oper_log` VALUES (182, '员工管理', 2, 'com.scheduling.project.system.cust.controller.CustController.recharge()', 'POST', 1, 'admin', '研发部门', '/system/cust/recharge', '127.0.0.1', '内网IP', '{\"id\":[\"3971\",\"3971\"],\"name\":[\"zsm1\"],\"sex\":[\"男\"],\"phone\":[\"13213131313\"],\"balance\":[\"3076.48\"],\"recharge\":[\"1111\"]}', '{\"msg\":\"操作成功\",\"code\":0}', 0, NULL, '2023-06-08 17:20:17');
INSERT INTO `sys_oper_log` VALUES (183, '员工管理', 2, 'com.scheduling.project.system.cust.controller.CustController.recharge()', 'POST', 1, 'admin', '研发部门', '/system/cust/recharge', '127.0.0.1', '内网IP', '{\"id\":[\"3971\",\"3971\"],\"name\":[\"zsm1\"],\"sex\":[\"男\"],\"phone\":[\"13213131313\"],\"balance\":[\"4187.48\"],\"recharge\":[\"00\"]}', '{\"msg\":\"操作成功\",\"code\":0}', 0, NULL, '2023-06-08 17:20:24');
INSERT INTO `sys_oper_log` VALUES (184, '员工管理', 2, 'com.scheduling.project.system.cust.controller.CustController.recharge()', 'POST', 1, 'admin', '研发部门', '/system/cust/recharge', '127.0.0.1', '内网IP', '{\"id\":[\"3971\",\"3971\"],\"name\":[\"zsm1\"],\"sex\":[\"男\"],\"phone\":[\"13213131313\"],\"balance\":[\"4187.48\"],\"recharge\":[\"00\"]}', '{\"msg\":\"操作成功\",\"code\":0}', 0, NULL, '2023-06-08 17:20:30');
INSERT INTO `sys_oper_log` VALUES (185, '员工管理', 2, 'com.scheduling.project.system.cust.controller.CustController.recharge()', 'POST', 1, 'admin', '研发部门', '/system/cust/recharge', '127.0.0.1', '内网IP', '{\"id\":[\"3971\",\"3971\"],\"name\":[\"zsm1\"],\"sex\":[\"男\"],\"phone\":[\"13213131313\"],\"balance\":[\"4187.48\"],\"recharge\":[\"-66\"]}', '{\"msg\":\"操作成功\",\"code\":0}', 0, NULL, '2023-06-08 17:20:37');
INSERT INTO `sys_oper_log` VALUES (186, '员工管理', 2, 'com.scheduling.project.system.cust.controller.CustController.recharge()', 'POST', 1, 'admin', '研发部门', '/system/cust/recharge', '127.0.0.1', '内网IP', '{\"id\":[\"3972\",\"3972\"],\"name\":[\"test11\"],\"sex\":[\"男\"],\"phone\":[\"13213131313\"],\"balance\":[\"1671.44\"],\"recharge\":[\"77\"]}', '{\"msg\":\"操作成功\",\"code\":0}', 0, NULL, '2023-06-08 17:20:48');
INSERT INTO `sys_oper_log` VALUES (187, '员工管理', 2, 'com.scheduling.project.system.cust.controller.CustController.consume()', 'POST', 1, 'admin', '研发部门', '/system/cust/consume', '127.0.0.1', '内网IP', '{\"id\":[\"3972\",\"3972\"],\"name\":[\"test11\"],\"sex\":[\"男\"],\"phone\":[\"13213131313\"],\"balance\":[\"1748.44\"],\"consume\":[\"7\"],\"discount\":[\"77\"]}', '{\"msg\":\"操作成功\",\"code\":0}', 0, NULL, '2023-06-08 17:20:52');
...
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '岗位信息表' ROW_FORMAT = COMPACT;
...
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '角色信息表' ROW_FORMAT = COMPACT;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '角色和部门关联表' ROW_FORMAT = COMPACT;
...
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '用户信息表' ROW_FORMAT = COMPACT;

-- ----------------------------
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 103, 'admin', '测试1', '00', 'ceshi@qq.com', '15888888888', '1', '', '29c67a30398638269fe600f73a054934', '111111', '0', '0', '127.0.0.1', '2023-06-08 17:35:22', '2023-02-11 18:06:05', 'admin', '2023-02-11 18:06:05', '', '2023-06-08 17:35:22', '管理员');
...
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '在线用户记录' ROW_FORMAT = COMPACT;
...
) ENGINE = InnoDB CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '用户与岗位关联表' ROW_FORMAT = COMPACT;
...
CREATE TABLE `typesetting_rules`  (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '排版规则ID',
  `rules_type` int NULL DEFAULT NULL COMMENT '可选值:开店规则、关店规则、客流规则。可扩展\n',
  `store` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '门店',
  `rule_value` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '规则值',
  `create_by` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '创建者',
  `create_time` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `update_by` varchar(64) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '' COMMENT '更新者',
  `update_time` datetime NULL DEFAULT NULL COMMENT '更新时间',
  `remark` varchar(500) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL COMMENT '备注',
  `del_flag` char(1) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '0' COMMENT '删除标志（0代表存在 2代表删除）',
  `rule_status` int NULL DEFAULT NULL COMMENT '排班规则（1.固定规则2.自定义规则）',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 16 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '排版规则管理' ROW_FORMAT = DYNAMIC;
